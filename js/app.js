(() => {
    ...
    function initSliders() {
        if (document.querySelector(".gallery-support")) new swiper_core_Swiper(".gallery-support.swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4.5,
            ...
            speed: 800,
            navigation: {
                prevEl: ".gallery-support__swiper-button-prev",
                nextEl: ".gallery-support__swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 2
        ...
        if (document.querySelector(".reviews-text__slider") && document.querySelector(".reviews-authors__slider")) {
            let slider1 = new swiper_core_Swiper(".reviews-text__slider.swiper", {
                ...
                navigation: {
                    prevEl: ".reviews-text__swiper-button-prev",
                    nextEl: ".reviews-text__wiper-button-next"
                },
                on: {}
            });
            let slider2 = new swiper_core_Swiper(".reviews-authors__slider.swiper", {
                modules: [ Navigation, Controller, EffectFade ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                navigation: {
                    prevEl: ".reviews-authors__swiper-button-prev",
                    nextEl: ".reviews-authors__swiper-button-next"
                },
                on: {}
            });
